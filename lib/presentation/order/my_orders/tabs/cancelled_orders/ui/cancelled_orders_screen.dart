...
import 'package:coffeeshopapp/presentation/order/my_orders/tabs/cancelled_orders/bloc/cancelled_orders_bloc.dart';
...
class _CancelledOrdersScreenState extends State<CancelledOrdersScreen> {
  ...
  CancelledOrdersBloc cancelledOrdersBloc = CancelledOrdersBloc();

  @override
  void initState() {
    cancelledOrdersBloc.add(CancelledOrdersInitialEvent());
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CancelledOrdersBloc, CancelledOrdersState>(
      bloc: cancelledOrdersBloc,
      listener: (context, state) {},
      builder: (context, state) {
        switch (state.runtimeType) {
          case CancelledOrdersLoadingState:
            return Container(
              child: Center(
          ...
          case CancelledOrdersErrorState:
            return Center(
              child: Text(
          ...
          case CancelledOrdersLoadedSuccessState:
            final successState = state as CancelledOrdersLoadedSuccessState;
            return Container(
